...
public class OrderComparator implements Comparator<Object> {
	...
	private int doCompare(@Nullable Object o1, @Nullable Object o2, @Nullable OrderSourceProvider sourceProvider) {
		...
		/** 如果o1实现了PriorityOrdered接口，o2没有实现，o1排在前面*/
		if (p1 && !p2) {
			return -1;
		}
		/** 如果o2实现了PriorityOrdered接口，o1没有实现，o1排在前面*/
		else if (p2 && !p1) {
			return 1;
		}
		/** 如果o1，o2都实现了或者都没有实现PriorityOrdered接口，则根据Order值进行排序（order值越小，优先级越高） */
		/** 获取o1的Ordered值，如果o1没有实现Ordered接口，值为Ordered.LOWEST_PRECEDENCE（Int的最大值） */
		int i1 = getOrder(o1, sourceProvider);
		/** 获取o2的Ordered值，如果o2没有实现Ordered接口，值为Ordered.LOWEST_PRECEDENCE（Int的最大值） */
